...
* **SREAA-368:** Min OpenTofu version raised to 1.12.
AzureRM provider min version raised to 5.0.

### Features

* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) 0fc2e52

### Bug Fixes

* **SREAA-368:** align v9 branch with current pipeline and provider constraints d87265a

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 bf39a15
* **deps:** update dependency tflint to v0.64.0 d5a4429
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template 3bce28c
* **v9:** 🐛 synchronize common files and docs 76fd2f5

## 8.1.5 (2026-07-20)

### Bug Fixes

* **tflint:** 🐛 bump Azure rules version, fix signature bug 59cecaf

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 176416e
* **deps:** update dependency opentofu to v1.12.2 6d9e95d
* **deps:** update dependency opentofu to v1.12.3 8930f16
* **deps:** update dependency opentofu to v1.12.4 eeccc80
* **deps:** update dependency tflint to v0.63.1 876145c
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 21a1fd0
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 cfb74d6

## 8.1.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 41fa6d6

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu 9249955
* **deps:** update dependency opentofu to v1.12.0 617b171
* **deps:** update dependency terraform-docs to v0.23.0 3884a0f
* **deps:** update dependency terraform-docs to v0.24.0 443cb11
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 7ac1c27
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 1038311
* **deps:** update tools d6b6ce6
* **pre-commit:** 🔧 move to prek 2155b9a
* **tfdocs:** bump tfdocs to v0.22 🔧 f583b73

## 8.1.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 805da6c

### Code Refactoring

* update module structure and Github actions 👷 939fdfa

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing eaac5cb
* **deps:** 🔗 bump tflint rules version d1c7a5e
* **deps:** update dependency trivy to v0.69.2 874346f
* **deps:** update dependency trivy to v0.69.3 049282f
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 18ffdd1

## 8.1.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 6c12efc

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 0a58826
* **deps:** update dependency opentofu to v1.11.2 4676f2c
* **deps:** update dependency opentofu to v1.11.3 8be8b1c
* **deps:** update dependency opentofu to v1.11.4 28453bb
* **deps:** update dependency opentofu to v1.11.5 b339740
* **deps:** update dependency pre-commit to v4.4.0 4288643
* **deps:** update dependency pre-commit to v4.5.0 992643d
* **deps:** update dependency pre-commit to v4.5.1 e729798
* **deps:** update dependency tflint to v0.60.0 7df0438
* **deps:** update dependency tflint to v0.61.0 b153f05
* **deps:** update dependency trivy to v0.67.1 52cc183
* **deps:** update dependency trivy to v0.67.2 f4d2615
* **deps:** update dependency trivy to v0.68.1 6fbcfff
* **deps:** update dependency trivy to v0.68.2 da64073
* **deps:** update dependency trivy to v0.69.0 1a66fe3
* **deps:** update dependency trivy to v0.69.1 8cf9e27
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 bfba570
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 f23a515
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 5367a46
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 032f7f6
* **deps:** update tools 116ebd1
